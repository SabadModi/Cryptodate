                        ...
                        <div
                            ...
                            <div class="block w-full overflow-x-auto">
                                ...
                                <table class="items-center w-full bg-transparent border-collapse">
                                    ...
                                    <tbody>
                                        <?php
                            $json = file_get_contents('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=50&page=1&sparkline=false&price_change_percentage=24h');
                            $obj = json_decode($json);
                            foreach ($obj as $jsonObj) :
                            ?>
                                        <tr>
                                            <th
                                                ...
                                                <span class="ml-3 font-bold text-white">
                                                    <?php echo $jsonObj->name; ?> - <?php echo $jsonObj->symbol; ?>
                                                </span>
                                            </th>
                                            <td
                                            ...
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <?php echo $jsonObj->market_cap; ?>
                                            </td>
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <?php echo $jsonObj->market_cap_rank; ?>
                                            </td>
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <?php echo $jsonObj->price_change_24h; ?> USD

                                            </td>
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <?php echo $jsonObj->circulating_supply; ?>
                                            </td>
                                            <td
                                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                <?php echo $jsonObj->max_supply; ?>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
